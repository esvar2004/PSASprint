...
from psa.models import predictive, TopPredictive
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        csv_file_path = os.path.join(base_dir, 'data', 'equipment_data_with_predictions.csv')
